...
$mahasiswa1 = new Mahasiswa('Afghan', getRandomNim());
$mahasiswa2 = new Mahasiswa('Alif', getRandomNim());
$mahasiswa3 = new Mahasiswa('Arum', getRandomNim());
$mahasiswa4 = new Mahasiswa('Fendy', getRandomNim());
